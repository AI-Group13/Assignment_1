...
def draw_graph(currentScene, N, point_list, square_size, window_size):
    ...
    for loc in newQueenLoc:
        pygame.draw.circle(screen, red, (point_list[loc][0]+square_size/2, \
        point_list[loc][1] +square_size/2), int(square_size*0.3))              #Visualizing the initial config
        pygame.display.update()
    time.sleep(1)
